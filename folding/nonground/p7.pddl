(define (problem folding_zigzag_3_2_29836problem)
 (:domain folding_zigzag_3_2_29836domain)
 (:objects
   n1 n2 n3 - node
 ...
 (:goal (and (at n1 c3 c3) (at n2 c4 c3) (at n3 c4 c2) (not (rotating))))
(:constraints (sometime (at n1 c4 c4)) (sometime-after (at n1 c4 c4) (exists (?n - node) (heading ?n down))))
)
