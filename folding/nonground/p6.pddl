(define (problem folding_zigzag_3_2_567199problem)
 (:domain folding_zigzag_3_2_567199domain)
 (:objects
   n1 n2 n3 - node
 ...
 (:goal (and (at n1 c3 c3) (at n2 c2 c3) (at n3 c2 c4) (not (rotating))))
(:constraints (sometime-before (at n1 c4 c5) (exists (?n - node) (heading ?n down))))
)
