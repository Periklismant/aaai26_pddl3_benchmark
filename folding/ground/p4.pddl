(define (problem folding_zigzag_3_2_482061problem)
 (:domain folding_zigzag_3_2_482061domain)
 (:objects
   n1 n2 n3 - node
 ...
 (:constraints (sometime (at n3 c4 c4)) (sometime-before (at n3 c4 c4) (or (heading n1 left) (heading n2 down))))
)
