(define (problem folding_zigzag_3_2_48520problem)
 (:domain folding_zigzag_3_2_48520domain)
 (:objects
   n1 n2 n3 - node
 ...
 (:goal (and (at n1 c3 c3) (at n2 c2 c3) (at n3 c2 c2) (not (rotating))))
 (:constraints (sometime (at n3 c1 c3)) (sometime-after (at n3 c1 c3) (or (at n3 c4 c4) (heading n3 right))))
)
