(define (problem folding_zigzag_3_2_912366problem)
 (:domain folding_zigzag_3_2_912366domain)
 (:objects
   n1 n2 n3 - node
 ...
 (:constraints (sometime (heading n2 down)) (sometime-before (heading n2 down) (not (free c3 c2))))
)
