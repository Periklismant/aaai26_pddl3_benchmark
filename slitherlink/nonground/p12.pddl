;; generatepddl.py gen 4 3 problems/p12.pddl plan
;;
;;  2.3    
;;  .3.    
;;  ...    
...
(define (problem sliterlink817709)
(:domain slitherlink)
...
(:init
    ...
    (CELLCAPACITY cell30 cap3)
    (CELLCAPACITY cell31 cap4)
...
(:goal
    (and
        ...
        (CELLCAPACITY cell30 cap0)
        (CELLCAPACITY cell32 cap0)
    )
)
(:constraints (sometime-after (CELLCAPACITY cell01 cap0) (exists (?c - cell) (CELLCAPACITY ?c cap3))))
)
