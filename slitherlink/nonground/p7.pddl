;; generatepddl.py gen 3 3 problems/p7.pddl plan
;;
;;  ..2    
;;  2.2    
;;  .33    
...
(define (problem sliterlink193996)
(:domain slitherlink)
...
(:init
    ...
    (CELLCAPACITY cell02 cap2)
    (CELLCAPACITY cell10 cap2)
    (CELLCAPACITY cell11 cap4)
    (CELLCAPACITY cell12 cap2)
...
(:constraints (sometime (linked n01 n02)) (sometime-before (linked n01 n02) (exists (?c1 - cell) (exists (?c2 - cell) (and (CELLCAPACITY ?c1 cap1) (CELLCAPACITY ?c2 cap1))))))
)
