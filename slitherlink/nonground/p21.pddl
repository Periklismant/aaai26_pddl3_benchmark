;; generatepddl.py gen 5 4 problems/p21.pddl plan
;;
;;  3.2.     
;;  ..2.     
;;  3..2     
...
(define (problem sliterlink671662)
(:domain slitherlink)
...
(:constraints (sometime (exists (?c1 - cell) (exists (?c2 - cell) (and (CELLCAPACITY ?c1 cap1) (CELLCAPACITY ?c2 cap1))))))
)
