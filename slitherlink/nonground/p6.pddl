;; generatepddl.py gen 3 3 problems/p6.pddl plan
;;
;;  .20    
;;  2.2    
;;  ...    
...
(define (problem sliterlink711731)
(:domain slitherlink)
...
(:constraints (at-most-once (exists (?c1 - cell) (exists (?c2 - cell) (and (CELLCAPACITY ?c1 cap1) (CELLCAPACITY ?c2 cap1))))))
)
