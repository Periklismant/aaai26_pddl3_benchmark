;; generatepddl.py gen 4 4 problems/p15.pddl plan
;;
;;  3.22     
;;  ..3.     
;;  ....     
...
(define (problem sliterlink960475)
(:domain slitherlink)
...
(:constraints (at-most-once (exists (?c1 - cell) (exists (?c2 - cell) (and (CELLCAPACITY ?c1 cap0) (CELLCAPACITY ?c2 cap3))))))
)
