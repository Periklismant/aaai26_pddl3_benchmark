;; generatepddl.py gen 3 4 problems/p11.pddl plan
;;
;;  3...     
;;  32..     
;;  .22.     
...
(define (problem sliterlink745130)
(:domain slitherlink)
...
(:constraints (sometime-before (CELLCAPACITY cell01 cap0) (exists (?c - cell) (CELLCAPACITY ?c cap0))))
)
