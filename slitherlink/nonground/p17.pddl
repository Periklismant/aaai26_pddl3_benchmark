;; generatepddl.py gen 4 4 problems/p17.pddl plan
;;
;;  ...2     
;;  23.3     
;;  1...     
...
(:constraints (sometime (linked n10 n11)) (sometime-after (linked n10 n11) (exists (?c1 - cell) (exists (?c2 - cell) (and (CELLCAPACITY ?c1 cap0) (CELLCAPACITY ?c2 cap3))))))
)
