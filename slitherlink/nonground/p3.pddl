;; generatepddl.py gen 3 3 problems/p3.pddl plan
;;
;;  3..    
;;  323    
;;  ...    
...
(define (problem sliterlink440283)
(:domain slitherlink)
...
(:constraints (sometime (linked n00 n10)) (sometime-after (linked n00 n10) (exists (?c1 - cell) (exists (?c2 - cell) (and (CELLCAPACITY ?c1 cap0) (CELLCAPACITY ?c2 cap3))))))
)
