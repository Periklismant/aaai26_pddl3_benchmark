;; generatepddl.py gen 5 4 problems/p20.pddl plan
;;
;;  3.3.     
;;  ....     
;;  022.     
...
(define (problem sliterlink406562)
(:domain slitherlink)
...
(:constraints (sometime-after (CELLCAPACITY cell00 cap0) (CELLCAPACITY cell22 cap0)))
)
