;; generatepddl.py gen 3 3 problems/p4.pddl plan
;;
;;  32.    
;;  2..    
;;  3..    
...
(define (problem sliterlink325868)
(:domain slitherlink)
...
(:constraints (sometime-after (CELLCAPACITY cell00 cap0) (CELLCAPACITY cell01 cap0)))
)
