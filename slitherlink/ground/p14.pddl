;; generatepddl.py gen 4 4 problems/p19.pddl plan
;;
;;  22.3     
;;  ....     
;;  12..     
...
(define (problem sliterlink32156)
(:domain slitherlink)
...
(:constraints (sometime-after (CELLCAPACITY cell00 cap0) (CELLCAPACITY cell21 cap0)))
)
