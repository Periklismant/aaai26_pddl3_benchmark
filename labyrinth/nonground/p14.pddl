...
(:constraints (sometime (robotat card1)) (sometime-before (robotat card1) (exists (?pos1 - gridpos) (exists (?bottompos1 - gridpos) (and (next ?pos1 ?bottompos1) (cardat card2 pos1 ?pos1) (cardat card1 pos1 ?bottompos1))))))
)
