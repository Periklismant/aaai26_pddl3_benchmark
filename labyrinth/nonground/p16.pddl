...
(:constraints (sometime (exists (?pos1 - gridpos) (exists (?bottompos1 - gridpos) (exists (?pos2 - gridpos) (and (next ?pos1 ?bottompos1) (cardat card2 ?pos2 ?pos1) (cardat card1 ?pos2 ?bottompos1)))))))
)
