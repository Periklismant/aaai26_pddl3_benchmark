(define (problem labyrinthsize4rotations0seed91)
(:domain labyrinth)
(:objects
...
(:constraints (sometime (robotat card1)) (sometime-after (robotat card1) (exists (?pos1 - gridpos) (exists (?bottompos1 - gridpos) (and (next ?pos1 ?bottompos1) (cardat card2 pos0 ?pos1) (cardat card1 pos0 ?bottompos1))))))
)
