(define (problem labyrinthsize4rotations0seed92)
(:domain labyrinth)
(:objects
...
(:constraints (sometime (exists (?pos1 - gridpos) (exists (?bottompos1 - gridpos) (and (next ?pos1 ?bottompos1) (cardat card2 pos1 ?pos1) (cardat card1 pos1 ?bottompos1))))))
)
