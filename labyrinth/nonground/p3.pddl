(define (problem labyrinthsize2rotations0seed205problem)
 ...
 (:goal (and (left)))
 (:constraints (sometime (exists (?pos1 - gridpos) (exists (?rightpos1 - gridpos) (exists (?pos2 - gridpos)  (and (next ?pos1 ?rightpos1) (cardat card0 ?pos1 ?pos2) (cardat card2 ?rightpos1 ?pos2)))))))
)
